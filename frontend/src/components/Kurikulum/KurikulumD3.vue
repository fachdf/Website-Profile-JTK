<template>
  <div align=center class="title">
    <p class="display-2 btext font-weight-bold" >D3 Teknik Informatika</p>
    <v-sheet
      margin-top="10"
      height="5"
      width="600"
...
<script>
  ...
  export default {    
    ...
    methods: {
      async fetchData() {
        const tracer = await axios.get("http://103.134.154.227:1337/curriculums/6296db254f2eb424b8cb9d6c");
