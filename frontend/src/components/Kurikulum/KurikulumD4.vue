<template>
  <div align=center class="title">
    <p class="display-2 btext font-weight-bold" >D4 Teknik Informatika</p>
    <v-sheet
      margin-top="10"
      height="5"
      width="600"
...
<script>
  ...
  export default {    
    ...
    methods: {
      async fetchData() {
        const kurikulum = await axios.get("http://103.226.138.60:1337/curriculums/6296db194f2eb424b8cb9d6a");
