<template>
 ...
 <div align=center  class="title">
      <p align=center class="display-2 mt-10 pl-10 btext font-weight-bold" >Tingkat Sebaran Pekerjaan</p>
    <v-sheet
        height="10"
        width="100%"
        color="white"
